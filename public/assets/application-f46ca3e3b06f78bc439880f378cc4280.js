...
(function() { this.JST || (this.JST = {}); this.JST["items/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<textarea name="title" class="item-title-input"></textarea>\n<button type="submit">Add</button>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["items/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p>',  item.escape('title') ,'</p>\n');  if (item.get('done')) { ; __p.push('\n  <span class="check">&#x2713;</span>\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layout/_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li>\n  <span class=\'header\'>\n    <a href=\'#\' class=\'cancel\'>\n      <span\n        class=\'glyphicon glyphicon-chevron-left pull-left\'>\n      </span>\n    </a>\n    Add\n  </span>\n</li>\n<li class=\'divider\'></li>\n<li>\n  <form>\n    <label>\n      <b>Title:</b>\n    </label>\n    <br>\n    <input\n      type=\'text\'\n      placeholder=\'Untitled Board\'\n      autofocus=\'true\'>\n    <button class=\'btn btn-success\'>Create</button>\n  </form>\n</li>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["layouts/_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li>\n  <span class=\'header\'>\n    <a href=\'#\' class=\'cancel\'>\n      <span\n        class=\'glyphicon glyphicon-chevron-left pull-left\'>\n      </span>\n    </a>\n    Add\n  </span>\n</li>\n<li class=\'divider\'></li>\n<li>\n  <form>\n    <label>\n      <b>Title:</b>\n    </label>\n    <br>\n    <input\n      type=\'text\'\n      placeholder=\'Untitled Board\'\n      autofocus=\'true\'>\n    <button class=\'btn btn-success\'>Create</button>\n  </form>\n</li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layouts/dropdown"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li>\n  <span class=\'header\'>Add</span>\n</li>\n<li class=\'divider\'></li>\n<li>\n  <a class=\'new-board\' href=\'#\'>\n    <b>New Board...</b>\n    <span class=\'add-item-description\'>\n      Make a new board! Boards are areas for you to keep lists for all kinds of purposes. Later, you can share your board to your coworkers and friends for collaborating!\n    </span>\n  </a>\n</li>\n');}return __p.join('');};
}).call(this);
