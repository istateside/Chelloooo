...
(function() { this.JST || (this.JST = {}); this.JST["boards/delete_modal"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="board-modal-backdrop">\n</div>\n<div class="board-modal">\n  <h4>',  board.escape('title') ,'</h4>\n  Are you sure you want to delete "',  board.escape('title') ,'"?\n  <br>Once it\'s deleted, it will be gone forever.\n\n  <br><br>\n  <button class="confirm">Yes, delete it.</button>\n  <button class="deny">Nevermind, keep it.</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>My Boards</h1>\n<ul>\n  ');  boards.each(function(board) { ; __p.push('\n    <li data-id="',  board.escape('id') ,'">\n      <a\n        href="#/board/',  board.escape('id') ,'"\n        class="board-link">',  board.escape('title') ,'</a>\n      <button\n        class="delete-btn"\n        type="button"\n        data-id="',  board.escape('id') ,'">&times</button>\n    </li>\n  ');  }); ; __p.push('\n</ul>\n\n<h2>Shared Boards</h2>\n<ul>\n  ');  shared_boards.each(function(board) { ; __p.push('\n    <li data-id="',  board.escape('id') ,'">\n      <a\n        href="#/board/',  board.escape('id') ,'"\n        class="board-link">',  board.escape('title') ,'</a>\n    </li>\n  ');  }); ; __p.push('\n</ul>\n\n<p>Select a board, or add a new one by clicking the \'+\' symbol!</p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>\n  <h1>Creating a new board</h1>\n  <p>Use this form to create a new board!</p>\n\n  <p>Boards can be used to track all kinds of things. Later, you can share your board to be tracked by multiple users.</p>\n</div>\n\n<div>\n  <form>\n    <div class="input-group">\n      <label for="title">Title</label>\n      <input type="text" name="board[title]" placeholder="My New Board">\n    </div>\n\n    <input type="submit">\n\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>',  board.escape('title') ,'</h1>\n<a href="javascript:void(0)" id="new-list">Add a new list</a>\n<div class="list-list">\n\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cards/modal"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="card-modal-backdrop">\n</div>\n<div class="card-modal">\n  <a class="card-modal-dismiss glyphicon glyphicon-remove" href="javascript:void(0)"></a>\n  <h4>',  card.escape('title') ,'</h4>\n  <p>',  card.escape('description') ,'</p>\n  <div class="card-modal-items"></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cards/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class="card-form">\n  <div class="panel-heading">\n    <input\n      type="text"\n      class="card-title-input bare-input"\n      name="title"\n      placeholder="">\n  </div>\n  <input type="submit" value="Add a card" class="btn btn-default">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cards/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel-heading">\n  <p class="list-header">',  card.escape('title') ,'</p>\n\n  <button class="delete-btn card" type="button">&times</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["items/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<input type="text" name="title" class="item-title-input"></input>\n<button type="submit">Add</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["items/list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="item-list-items"></ul>\n<div class="item-list-form"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["items/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class="item-form">\n  <input\n    type="text"\n    class="form-control bare-input"\n    placeholder="Gotta do this thing!"\n    name="title">\n\n  <input type="submit" value="Add an item" class="btn btn-default">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["items/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p class="item">',  item.escape('title') ,'<span class="check">&#x2713;</span></p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layout/_invite_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li>\n  <span class=\'header\'>\n    <a href=\'#\' class=\'cancel\'>\n      <span\n        class=\'glyphicon glyphicon-chevron-left pull-left\'>\n      </span>\n    </a>\n    Invite users!\n  </span>\n</li>\n<li class=\'divider\'></li>\n<li>\n  <form id="invite-user-form" role="form">\n    <div class="form-group">\n      <label>\n        <b>Board:</b>\n      </label>\n      <br>\n      <select class="board-select form-control">\n        ');  _.each(Chellooo.Collections.boards.models, function(board) { ; __p.push('\n          <option data-id="',  board.id ,'">',  board.escape('title') ,'</option>\n        ');  }); ; __p.push('\n      </select>\n    </div>\n    <br>\n    <div class="form-group">\n      <label id="email-label">\n        <b>Email:</b>\n      </label>\n      <br>\n      <input\n        class="form-control"\n        type=\'text\'\n        placeholder=\'Email\'\n        autofocus=\'true\'>\n      </div>\n    <button class=\'btn btn-success\'>Invite!</button>\n  </form>\n</li>\n<li class="notify"></li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layout/_new_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li>\n  <span class=\'header\'>\n    <a href=\'#\' class=\'cancel\'>\n      <span\n        class=\'glyphicon glyphicon-chevron-left pull-left\'>\n      </span>\n    </a>\n    Add a new board\n  </span>\n</li>\n<li class=\'divider\'></li>\n<li>\n  <form id="new-board-form">\n    <label>\n      <b>Title:</b>\n    </label>\n    <br>\n    <input\n      type=\'text\'\n      placeholder=\'Untitled Board\'\n      autofocus=\'true\'>\n    <button class=\'btn btn-success\'>Create</button>\n  </form>\n</li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["layout/dropdown"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li>\n  <span class=\'header\'>Add boards, or invite other users!</span>\n</li>\n<li class=\'divider\'></li>\n<li>\n  <a class=\'new-board\' href=\'#\'>\n    <b>New Board...</b>\n    <span class=\'add-item-description\'>\n      Make a new board!\n      <br>\n      Boards are areas for you to keep lists for all kinds of purposes.\n      <br>\n      Later, you can share your board to your coworkers and friends for collaborating!\n    </span>\n  </a>\n</li>\n<li class=\'divider\'></li>\n<li>\n  <a class="invite-user" href="#">\n    <b>Invite users to an existing board!</b>\n    <span class="invite-user-description">\n      Invite your friends or coworkers to view and edit your board with you!\n      <br>\n      Chellooo is great for keeping track of what it is that a team needs to get done to reach their goals.\n      <br>\n      Why do it alone?\n    </span>\n  </a>\n</li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form id="new-list-form">\n  <input\n    type="text"\n    id="title"\n    placeholder="List Title"\n    name="title">\n  <input\n    type=\'submit\'\n    class="list-submit"\n    value="',  String.fromCharCode(43) ,'">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="list-header-div">\n  <h2 class="list-header">',  list.escape('title') ,'</h2>\n  <p class="list-desc">',  list.escape('description') ,'</p>\n</div>\n<div class="card-list">\n\n</div>\n<div class="new-list-space">\n</div>\n<a href="javascript:void(0)" id="new-card">Add a new card</a>\n');}return __p.join('');};
}).call(this);
...
Chellooo.Views.CardModal = Backbone.CompositeView.extend({
  initialize: function() {
    this.model.fetch();
    this.listenTo(this.model, 'sync', this.render);
    this.itemListView = new Chellooo.Views.ItemsList({
...
Chellooo.Views.ItemForm = Backbone.View.extend({
